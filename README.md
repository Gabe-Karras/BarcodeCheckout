...
```
***
Start the php server with `php -S localhost:8000`. You can then navigate to the beginning page of the program through your browser. (ex: localhost:8000/HomePage.php)
***
